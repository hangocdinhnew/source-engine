...
// flag set, that 			is the entity that will be returned.
// Otherwise, the first entity of 			the given classname is
// returned.
...
// randomly-picked point 			 along the spine will be one
// that is exposed above the hole or 			 between rungs of a
// ladder.)
// Input   :
// Output  :
//------------------------------------------------------------------------------
